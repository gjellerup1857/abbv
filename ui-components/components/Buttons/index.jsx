...
const kindStyles = {
  ...
  outline: ['text-primary', 'fill-primary', 'stroke-primary', 'border', 'border-primary', 'hover:bg-primary', 'hover:text-primary-content', 'hover:stroke-secondary', 'hover:fill-primary-content'],
