...
const callback = (environment, ...filters) => {
  ...
  const {Map: Map$c, RegExp: RegExp$3, Set: Set$2, WeakMap: WeakMap$5, WeakSet: WeakSet$b} = classes;
  ...
  const {Map: Map$b, WeakMap: WeakMap$4, WeakSet: WeakSet$a, setTimeout: setTimeout$3} = env;
  ...
  const {getOwnPropertyDescriptor: getOwnPropertyDescriptor$1, setPrototypeOf: setPrototypeOf$1} = Object$a;

  const {toString: toString$1} = Object$a.prototype;
  ...
  let {Math: Math$2, RegExp: RegExp$2} = $(window);
  ...
  function randomId() {
    ...
    return $(Math$2.floor(Math$2.random() * 2116316160 + 60466176)).toString(36);
  }

  let {
    parseFloat: parseFloat$3,
  ...
  function wrapPropertyAccess(object, property, descriptor,
    ...
    if (dotIndex == -1) {
      ...
      let currentDescriptor = Object$9.getOwnPropertyDescriptor(object, property);
      if (currentDescriptor && !currentDescriptor.configurable)
        return;

      let newDescriptor = Object$9.assign({}, descriptor, {
      ...
      Object$9.defineProperty(object, property, newDescriptor);
      return;
    }
    ...
    let currentDescriptor = Object$9.getOwnPropertyDescriptor(object, name);
    if (currentDescriptor && !currentDescriptor.configurable)
      return;
    ...
    Object$9.defineProperty(object, name, {
      get: () => value,
      set(newValue) {
        value = newValue;
        if (value && (typeof value == "object" || typeof value == "function")) {
  ...
  function abortOnIframe(
    ...
    for (let frame of Array$2.from(window.frames)) {
    ...
    function queryAndProxyIframe() {
      for (let frame of Array$2.from(window.frames)) {
        ...
        if (readProps.size > 0) {
          let props = Array$2.from(readProps);
          readProps.clear();
        ...
        if (writeProps.size > 0) {
          let props = Array$2.from(writeProps);
          writeProps.clear();
          for (let property of props)
  ...
  function addHooksOnDomAdditions(endCallback) {
    ...
    function getInnerHTMLDescriptor(target, property) {
      let desc = Object$9.getOwnPropertyDescriptor(target, property);
  ...
  let {HTMLScriptElement: HTMLScriptElement$1, Object: Object$8, ReferenceError: ReferenceError$1} = $(window);
  let Script = Object$8.getPrototypeOf(HTMLScriptElement$1);
  ...
  function abortCurrentInlineScript(api, search = null) {
    ...
    const {get: prevGetter, set: prevSetter} =
      Object$8.getOwnPropertyDescriptor(object, name) || {};
  ...
  const {assign, setPrototypeOf} = Object$7;
  ...
  let {getOwnPropertyDescriptor} = Object$6;
  ...
  function freezeElement(selector, options = "", ...exceptions) {
    ...
    observer = new MutationObserver$a(searchAndAttach);
    ...
    function markNodes(nodes, isChild = true) {
      for (let node of nodes) {
        if (!variables.frozen.has(node)) {
          ...
          if (!isChild && subtree) {
            new MutationObserver$a(mutationsList => {
  ...
  let {Array, Error: Error$6, Map: Map$8, parseInt: parseInt$2} = $(window);
  ...
  function race(action, winners = "1") {
    switch (action) {
      ...
      case "stop":
        ...
        break;
      default:
        throw new Error$6(`Invalid action: ${action}`);
    }
  }
  ...
  const {Map: Map$7, MutationObserver: MutationObserver$9, Object: Object$5, Set, WeakSet: WeakSet$9} = $(window);

  let ElementProto = Element.prototype;
  let {attachShadow} = ElementProto;

  let hiddenShadowRoots = new WeakSet$9();
  let searches = new Map$7();
  let observer = null;
  ...
  function hideIfShadowContains(search, selector = "*") {
    ...
    if (!observer) {
      observer = new MutationObserver$9(records => {
        let visited = new Set();
  ...
  const {Error: Error$5, JSON: JSON$2, Map: Map$6, Response: Response$2, Object: Object$4} = $(window);
  ...
  function jsonOverride(rawOverridePaths, value,
    ...
    if (!rawOverridePaths)
      throw new Error$5("[json-override snippet]: Missing paths to override.");

    if (typeof value == "undefined")
      throw new Error$5("[json-override snippet]: No value to override with.");
  ...
  let {Error: Error$4, JSON: JSON$1, Map: Map$5, Object: Object$3, Response: Response$1} = $(window);

  let paths = null;

  function jsonPrune(rawPrunePaths, rawNeedlePaths = "") {
    if (!rawPrunePaths)
      throw new Error$4("Missing paths to prune");
  ...
  let {Error: Error$2, Map: Map$4, Object: Object$2, console: console$1} = $(window);
  ...
  let {fetch: fetch$2, Map: Map$3, Object: Object$1, RegExp: RegExp$1, Response} = $(window);
  ...
  function replaceFetchResponse(search, replacement = "", needle = null) {
    ...
    if (!fetchRules) {
      ...
      window.fetch = proxy(fetch$2, (...args) => {
        const promise = apply$2(fetch$2, self, args).then(origResponse => {
          const clonedResponse = $(origResponse).clone();
          return clonedResponse.text().then(origText => {
            let replacedText = $(origText);

            for (const [thisSearch, {replacement: thisReplacement, needle: thisNeedle}] of fetchRules) {
              if (thisNeedle) {
              ...
              if (debug() && replacedText !== origText) {
            ...
            const replacedResponse = new Response(replacedText, {
    ...
    fetchRules.set(globalisedRegEx, {replacement, needle});
  }
  ...
  function replaceXhrResponse(search, replacement = "", needle = null) {
    ...
    if (!xhrInFlightRequests) {
      ...
      window.XMLHttpRequest = class extends XMLHttpRequest {
        ...
        get response() {
          ...
          for (const [thisSearch, {replacement: thisReplacement, needle: thisNeedle}] of xhrRules) {
            if (thisNeedle) {
              const needleRegex = toRegExp(thisNeedle);
            ...
            if (debug() && innerResponse !== replacedText) {
          ...
          return (xhrData.response = replacedText);
        }
        get responseText() {
    ...
    xhrRules.set(globalisedRegEx, {replacement, needle});
  }

  let {URL, fetch: fetch$1} = $(window);
  ...
  function stripFetchQueryParameter(name, urlPattern = null) {
    ...
    if (!parameters) {
      parameters = new Map();
      window.fetch = proxy(fetch$1, (...args) => {
        let [source] = args;
        ...
        return apply$2(fetch$1, self, args);
      });
    }
...
const graph = new Map([["abort-current-inline-script",null],["abort-on-iframe-property-read",null],["abort-on-iframe-property-write",null],["abort-on-property-read",null],["abort-on-property-write",null],["cookie-remover",null],["debug",null],["freeze-element",null],["hide-if-shadow-contains",null],["json-override",null],["json-prune",null],["override-property-read",null],["prevent-listener",null],["replace-fetch-response",null],["replace-xhr-response",null],["strip-fetch-query-parameter",null],["trace",null],["log",null],["race",null],["hide-if-matches-xpath",null],["hide-if-matches-computed-xpath",null],["hide-if-contains",null],["hide-if-contains-similar-text",null],["hide-if-contains-visible-text",null],["hide-if-contains-and-matches-style",null],["hide-if-has-and-matches-style",null],["hide-if-labelled-by",null],["hide-if-contains-image",null],["simulate-mouse-event",null],["skip-video",null]]);
