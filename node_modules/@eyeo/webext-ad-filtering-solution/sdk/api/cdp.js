...
import {Prefs, CDP_OPTED_IN, CDP_OPTED_OUT,
  ...
  from "./prefs.js";
import {domainSuffixes} from "adblockpluscore/lib/url.js";
import {matchesWildcards, hasWildcard} from "adblockpluscore/lib/url.js";
 ...
 */
export function _setConfig(newConfig) {
  cdpDomains = new Map();
