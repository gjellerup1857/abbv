...
This version only contains minor changes and internal fixes.
This version will not be released to our users.

- Updated webext-ad-filtering-solution to the version 1.17.0
