...
describe("test issue reporter", function () {
  ...
  it("should display issue reporter default state", async function () {
    ...
    expect(await issueReporterPage.isSelectIssueButtonDisplayed()).to.be.true;
    expect(await issueReporterPage.isSelectIssueButtonEnabled()).to.be.true;
    expect(await issueReporterPage.isMarkIssueButtonDisplayed()).to.be.true;
    expect(await issueReporterPage.isMarkIssueButtonEnabled()).to.be.false;
    expect(await issueReporterPage.isDetailsButtonDisplayed()).to.be.true;
    expect(await issueReporterPage.isDetailsButtonEnabled()).to.be.false;
    expect(await issueReporterPage.isDoneButtonDisplayed()).to.be.true;
    expect(await issueReporterPage.isDoneButtonEnabled()).to.be.false;
    expect(await issueReporterPage.isCancelButtonDisplayed()).to.be.true;
    expect(await issueReporterPage.isCancelButtonEnabled()).to.be.true;
    expect(await issueReporterPage.isContinueButtonDisplayed()).to.be.true;
