...
/*ABP*/
export const ABP_DELETE_COMMANDS = "deletecommandsABP";
...
export const ABP_NEWTAB_SUBDOMAIN = "newtabsubdomainABP";
...
/*AdBlock*/
export const AB_DELETE_COMMANDS = "deletecommandsAB";
...
export const AB_FREE_USER_OPD_PREMIUM = "opdnavigationpremiumfreeuserAB";
export const AB_FREE_USER_OPD_EXCLUSION = "opdnavigationexclusionfreeuserAB";
export const AB_FREE_USER_NEWTAB = "newtabfreefreeuserAB";
export const AB_NEWTAB_SUBDOMAIN = "newtabsubdomainAB";
export const AB_FREE_USER_NEWTAB_PREMIUM = "newtabpremiumfreeuserAB";
export const AB_FREE_USER_NEWTAB_FORCE = "newtabforcefreeuserAB";
export const AB_PREMIUM_USER_NEWTAB_PREMIUM = "newtabpremiumpremiumuserAB";
export const AB_PREMIUM_USER_NAVIGATION_FREE = "opdnavigationfreepremiumuserAB";
export const AB_PREMIUM_USER_NEWTAB = "newtabpremiumuserAB";
export const AB_MULTIPLE_COMMANDS = "multiplecommandsAB";

/*errors*/
export const ABP_DUPLICATE_OPD_NAVIGATION = "opdnavigationduplicateABP";
export const AB_DUPLICATE_OPD_NAVIGATION = "opdnavigationduplicateAB";
export const UNKNOWN_COMMAND = "unknowncommand";
export const MISSING_PARAMETER = "missingparameter";
export const WRONG_VERSION = "wrongversion";
export const INVALID_COMMAND = "invalidcommand";
export const TOO_MANY_COMMANDS = "toomanycommands";

/*standard ping*/
export const NO_CAMPAIGN = "nocampaign";
